"use client";
  ...
  import { bookingsData } from "@/lib/mockData"; // Import mock data
    ...
    return (
      <>
        ...
        <div className="relative mt-4 flex items-center">
          ...
          <input
            placeholder="Search for booking by User, Event, or ID"
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    variant="ghost"
                    className={`flex items-center gap-1 rounded-full text-sm ${
                      statusFilter.Pending ? "borderRES border-gray-400 font-medium" : ""
                    }`}
                    onClick={() =>
                      setStatusFilter((prev) => ({
                        ...prev,
